...
class Preprocess:
    ...
    def __init__(self,
                 ...
                 club_id=0,
                 nat_id=0) -> None:
        self._id           = (i for i in itertools.count())
        self._season       = season
        ...
        self._Division_id  = (i+division_id for i in itertools.count())
        self._Club_id      = (i+club_id for i in itertools.count())
        self._Nat_id       = (i+nat_id for i in itertools.count())
