...
class PlayerInfo(Base):
    ...
    position: Mapped[str]  = mapped_column(Integer, sql.ForeignKey('position.id'))
    rightfoot: Mapped[str] = mapped_column(Integer, sql.ForeignKey('foot.id'))
    leftfoot: Mapped[str]  = mapped_column(Integer, sql.ForeignKey('foot.id'))
    mins: Mapped[str]      = mapped_column(Integer)
    division: Mapped[str]  = mapped_column(Integer, sql.ForeignKey('division.id'))
    club: Mapped[str]      = mapped_column(Integer, sql.ForeignKey('club.id'))
    nat: Mapped[str]       = mapped_column(Integer, sql.ForeignKey('nat.id'))
